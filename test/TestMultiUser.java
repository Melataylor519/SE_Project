...
public class TestMultiUser {
	...
	public void compareMultiAndSingleThreaded() throws Exception {
		...
		List<String> singleThreaded = loadAllOutput(singleThreadFilePrefix, n_threads);
		List<String> multiThreaded = loadAllOutput(multiThreadFilePrefix, n_threads);
		Assert.assertEquals(singleThreaded, multiThreaded);
	}

	private List<String> loadAllOutput(String prefix, int n_threads) throws IOException {
